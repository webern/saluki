...
crate::declare_annotations! {
    ...
    MULTI_REGION_FAILOVER_API_KEY = SalukiAnnotation {
        schema: &super::schema::MULTI_REGION_FAILOVER_API_KEY,
    ...
    MULTI_REGION_FAILOVER_DD_URL = SalukiAnnotation {
        schema: &super::schema::MULTI_REGION_FAILOVER_DD_URL,
        support_level: SupportLevel::Full,
        additional_yaml_paths: &[],
    ...
    MULTI_REGION_FAILOVER_ENABLED = SalukiAnnotation {
        schema: &super::schema::MULTI_REGION_FAILOVER_ENABLED,
        support_level: SupportLevel::Full,
        additional_yaml_paths: &[],
    ...
    MULTI_REGION_FAILOVER_FAILOVER_METRICS = SalukiAnnotation {
        schema: &super::schema::MULTI_REGION_FAILOVER_FAILOVER_METRICS,
        support_level: SupportLevel::Full,
        additional_yaml_paths: &[],
    ...
    MULTI_REGION_FAILOVER_METRIC_ALLOWLIST = SalukiAnnotation {
        schema: &super::schema::MULTI_REGION_FAILOVER_METRIC_ALLOWLIST,
        support_level: SupportLevel::Full,
        additional_yaml_paths: &[],
    ...
    MULTI_REGION_FAILOVER_SITE = SalukiAnnotation {
        schema: &super::schema::MULTI_REGION_FAILOVER_SITE,
        support_level: SupportLevel::Full,
        additional_yaml_paths: &[],
