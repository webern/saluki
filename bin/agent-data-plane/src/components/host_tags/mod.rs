...
impl HostTagsConfiguration {
    /// Creates a new `HostTagsConfiguration` from an established Datadog Agent IPC client.
    pub fn from_client(client: RemoteAgentClient, expected_tags_duration: Duration) -> Self {
        Self {
            client,
