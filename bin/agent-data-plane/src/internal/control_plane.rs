...
pub async fn create_control_plane_supervisor(
    config_snapshot: serde_json::Value, ipc_cert_path: PathBuf, dp_config: &DataPlaneConfiguration,
    ...
    supervisor.add_worker(DynamicLogLevelWorker::new_native(logging_controller));
