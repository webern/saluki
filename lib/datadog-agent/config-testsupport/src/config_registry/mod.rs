...
pub use datadog::ALL_ANNOTATIONS;
pub use datadog::SUPPORTED_ANNOTATIONS;
pub use datadog_agent_config::config_registry::{structs, Pipeline, PipelineAffinity, Severity, SupportLevel};
